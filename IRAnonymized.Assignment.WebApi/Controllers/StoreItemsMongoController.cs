...
{
    /// <summary>
    /// Manages the <see cref="StoreItemModel "/> stored in the Mongo type Database.
    /// </summary>
    [Route("api/[controller]")]
    public class StoreItemsMongoController : ControllerBase
    {
        private readonly IStoreItemMongoService _service;
        private readonly ILogger<StoreItemsJsonController> _logger;
        private readonly IMapper _mapper;

        public StoreItemsMongoController(IStoreItemMongoService service, 
